// This is from https://github.com/leighmcculloch/go-optional/blob/main/optional.go
// Can't seem to use the dependency directly as it's not a local type and I can't extend the YAML method
package optional
...
func (o Optional[T]) MarshalYAML() (*T, error) {
	if o.IsPresent() {
		val, ok := o.Get()
		if !ok {
