...
type Metadata struct {
	Actions            optional.Optional[[]Action]               `json:"actions,omitempty" yaml:"actions,omitempty"`
	...
	Revisions          optional.Optional[[]RevisionHistoryEntry] `json:"revisions,omitempty" yaml:"revisions,omitempty"`
...
type PoamItem struct {
	...
	Props               optional.Optional[[]Property]           `json:"props,omitempty" yaml:"props,omitempty"`
	RelatedFindings     optional.Optional[[]RelatedFinding]     `json:"related-findings,omitempty" yaml:"related-findings,omitempty"`
	RelatedObservations optional.Optional[[]RelatedObservation] `json:"related-observations,omitempty" yaml:"related-observations,omitempty"`
	RelatedRisks        optional.Optional[[]AssociatedRisk]     `json:"related-risks,omitempty" yaml:"related-risks,omitempty"`
	Remarks             optional.Optional[string]               `json:"remarks,omitempty" yaml:"remarks,omitempty"`
	Title               string                                  `json:"title" yaml:"title"`
...
type Merge struct {
	...
	Flat    optional.Optional[FlatWithoutGrouping] `json:"flat,omitempty" yaml:"flat,omitempty"`
}

type Modify struct {
	Alters        optional.Optional[[]Alteration]       `json:"alters,omitempty" yaml:"alters,omitempty"`
...
type SystemCharacteristics struct {
	...
	Remarks                  optional.Optional[string]              `json:"remarks,omitempty" yaml:"remarks,omitempty"`
	ResponsibleParties       optional.Optional[[]ResponsibleParty]  `json:"responsible-parties,omitempty" yaml:"responsible-parties,omitempty"`
	SecurityImpactLevel      optional.Optional[SecurityImpactLevel] `json:"security-impact-level,omitempty" yaml:"security-impact-level,omitempty"`
	SecuritySensitivityLevel optional.Optional[string]              `json:"security-sensitivity-level,omitempty" yaml:"security-sensitivity-level,omitempty"`
...
type Link struct {
	...
	ResourceFragment optional.Optional[string] `json:"resource-fragment,omitempty" yaml:"resource-fragment,omitempty"`
	Text             optional.Optional[string] `json:"text,omitempty" yaml:"text,omitempty"`
}

type Property struct {
	Class   optional.Optional[string] `json:"class,omitempty" yaml:"class,omitempty"`
	Group   optional.Optional[string] `json:"group,omitempty" yaml:"group,omitempty"`
	Name    string                    `json:"name" yaml:"name"`
...
type Action struct {
	Date               optional.Optional[time.Time]          `json:"date,omitempty" yaml:"date,omitempty"`
	Links              optional.Optional[[]Link]             `json:"links,omitempty" yaml:"links,omitempty"`
	Props              optional.Optional[[]Property]         `json:"props,omitempty" yaml:"props,omitempty"`
	Remarks            optional.Optional[string]             `json:"remarks,omitempty" yaml:"remarks,omitempty"`
	ResponsibleParties optional.Optional[[]ResponsibleParty] `json:"responsible-parties,omitempty" yaml:"responsible-parties,omitempty"`
...
type Location struct {
	Address          optional.Optional[Address]           `json:"address,omitempty" yaml:"address,omitempty"`
...
type AssessedControls struct {
	Description     optional.Optional[string]                              `json:"description,omitempty" yaml:"description,omitempty"`
	ExcludeControls optional.Optional[[]AssessedControlsSelectControlById] `json:"exclude-controls,omitempty" yaml:"exclude-controls,omitempty"`
	IncludeAll      optional.Optional[IncludeAll]                          `json:"include-all,omitempty" yaml:"include-all,omitempty"`
	IncludeControls optional.Optional[[]AssessedControlsSelectControlById] `json:"include-controls,omitempty" yaml:"include-controls,omitempty"`
	Links           optional.Optional[[]Link]                              `json:"links,omitempty" yaml:"links,omitempty"`
	Props           optional.Optional[[]Property]                          `json:"props,omitempty" yaml:"props,omitempty"`
	Remarks         optional.Optional[string]                              `json:"remarks,omitempty" yaml:"remarks,omitempty"`
}
...
type SelectControlById struct {
	Matching          optional.Optional[[]Matching] `json:"matching,omitempty" yaml:"matching,omitempty"`
...
type CustomGrouping struct {
	Groups         optional.Optional[[]CustomGroupingGroup] `json:"groups,omitempty" yaml:"groups,omitempty"`
...
type Alteration struct {
	Adds      optional.Optional[[]Addition] `json:"adds,omitempty" yaml:"adds,omitempty"`
	ControlId string                        `json:"control-id" yaml:"control-id"`
	Removes   optional.Optional[[]Removal]  `json:"removes,omitempty" yaml:"removes,omitempty"`
}
...
type InformationType struct {
	AvailabilityImpact    optional.Optional[Impact]                          `json:"availability-impact,omitempty" yaml:"availability-impact,omitempty"`
	...
	ConfidentialityImpact optional.Optional[Impact]                          `json:"confidentiality-impact,omitempty" yaml:"confidentiality-impact,omitempty"`
	Description           string                                             `json:"description" yaml:"description"`
	IntegrityImpact       optional.Optional[Impact]                          `json:"integrity-impact,omitempty" yaml:"integrity-impact,omitempty"`
	Links                 optional.Optional[[]Link]                          `json:"links,omitempty" yaml:"links,omitempty"`
	Props                 optional.Optional[[]Property]                      `json:"props,omitempty" yaml:"props,omitempty"`
	Title                 string                                             `json:"title" yaml:"title"`
	UUID                  optional.Optional[string]                          `json:"uuid,omitempty" yaml:"uuid,omitempty"`
